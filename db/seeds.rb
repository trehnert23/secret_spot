...
Getting there: Fly into Longbeach Airport or Los Angeles International Airport and head to the Pacific Coast Highway.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach02.jpg", tag_id: t1.id)
...
Getting there: Your best bet is to fly into an international airport in China, such as Fuzhou, Guilin or Shanghai, then get an inexpensive local flight from local booking agencies www.c-trip.com or www.elong.net for as little as US$50 to Sanya airport. Riyuewan is a two-hour drive from the airport or stay in Sanya and get a local surf tour company to take you there.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach03.jpg", tag_id: t1.id)
...
Getting there: It’s only a two-hour drive south of Auckland, or get the InterCity bus from Auckland to Hamilton Central then the Busit/Gobus Route 23 to Raglan. The journey will cost around US$30 in total. ", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/beach04.jpg", tag_id: t1.id)
...
Getting there: Fly into the nearest city Guayaquil and get the superb CLP air-conditioned bus service from the center of town, which departs five times a day and takes just under three hours. It costs approximately US$10.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/history02.jpg", tag_id: t1.id)
...
Getting there: Fly in to Kapalua West Maui Airport and, depending on where you’re staying, you may get a free shuttle from the airport all the way to the beach, or just get a taxi directly there.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/history04.jpg", tag_id: t1.id)
...
Getting there: Fly into Male airport and get your live aboard company to pick you up from there. Trips range in duration and price. Visit www.surfatoll.com for details.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/skiing02.jpg", tag_id: t1.id)
...
Getting there: Fly in to Manila and get an internal flight with airlines such as Cebu Pacific to Siargao for as little as US$30.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/skiing03.jpg", tag_id: t1.id)
...
Getting there: Fly into Biarritz Airport and grab a taxi for approximately US$90 or hire a car for US$35 a day and follow the E70 and A63 up to Hossegor.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/skiing04.jpg", tag_id: t1.id)
...
Getting there: Fly directly into Lima and cab it to the Miraflores shopping center for around US$10. From there you’ll have a spectacular view out to sea and probably butterflies because the waves look that good.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/adventure02.jpg", tag_id: t1.id)
...
Destination.create(name: "Superbanks", description: "Gold Coast, Austrailia - Another of the world’s finest breaks, you may well have the ride of your life on this section, which will produce tubes and solid walls. By all means fill your boots, but save some energy for the two-kilometer walk along the beach back to your car.
	...
	Getting there: If you’re coming from overseas fly into Brisbane and pick up a car at the airport (www.brisbaneairportcarhire.net.au) for around US$46 per day.Drive down to Snapper Rocks, look for signs to Coolangatta and then turn off at Kirra and make your way to Greenmount or Snapper Rocks.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/adventure04.jpg", tag_id: t1.id)
...
Getting there: Fly into Denpasar Airport and get a very reasonably priced taxi down to Kuta for US$6 or US$12 to Uluwatu.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/family02.jpg", tag_id: t1.id)
...
Getting there: Eastern Cape province of South Africa, about an hour’s drive southwest of Port Elizabeth.", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/family03.jpg", tag_id: t1.id)
...
Getting there: Fly into Dillingham Airport on north shore and get a taxi or drive to Ehukai Beach Park in Pupukea (expect to pay around US$50 for airport transfers).", image: "http://s3.amazonaws.com/codecademy-content/courses/learn-rails/img/family04.jpg", tag_id: t1.id)